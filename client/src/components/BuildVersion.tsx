...
const BuildVersion = ({setActivePage}) => {
    return(
        <div 
            className="absolute left-0 bottom-0 w-full text-center lg:text-right text-xs 2xl:text-sm opacity-50 px-5 py-1 select-none underline hover:text-blue-500"
